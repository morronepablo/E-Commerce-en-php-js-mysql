$(document).ready(function() {
    ...
    function mostrar_pasarela(producto) {
        ...
        if(producto.imagenes.length > 0) {
            template += `
                <div class="col-12">
                    <img id="imagen_principal" src="/commerce/Util/img/producto/${producto.imagenes[0].nombre}" class="img-fluid">
                </div>
                ...
                producto.imagenes.forEach(imagen => {
                    template += `
                        <button prod_img="${imagen.nombre}" class="imagen_pasarelas product-image-thumb">
                            <img src="/commerce/Util/Img/producto/${imagen.nombre}">
                        </button>
                    `;
                });
            template += `
            ...
            template += `
                <div class="col-12">
                    <img id="imagen_principal" src="/commerce/Util/img/producto/${producto.imagen}" class="product-image img-fluid">
                </div>
            `;
        }
        $('#loader_3').hide(500);
        ...
        resenas.forEach(resena => {
            template += `
                <div class="card-comment">
                    <img class="img-circle img-sm" src="/commerce/Util/Img/Users/${resena.avatar}" alt="User Image">
    ...
    async function mostrar_comentarios() {
        ...
        let data = await fetch('/commerce/Controllers/PreguntaController.php',{
            method: 'POST',
            headers: {'Content-Type':'application/x-www-form-urlencoded'},
            body: 'funcion='+funcion
        })
                    ...
                    <div class="card-footer">
                        <form id="form_pregunta">
                            <div class="input-group">
                                <img class="direct-chat-img mr-2" src="/commerce/Util/Img/Users/${producto.avatar_sesion}" alt="Message User Image">
                ...
                template += `
                    ...
                    producto.preguntas.forEach(pregunta => {
                        ...
                        <div class="direct-chat-msg">
                            ...
                            <img class="direct-chat-img" src="/commerce/Util/Img/Users/${pregunta.avatar}" alt="Message User Image">
                            ...
                            if(pregunta.estado_respuesta == '0') {
                                ...
                                if(producto.bandera == '1') {
                                    ...
                                    <div class="card-footer">
                                        <form>
                                            <div class="input-group">
                                                <img class="direct-chat-img mr-2" src="/commerce/Util/Img/Users/${producto.avatar}" alt="Message User Image">
                                ...
                                <div class="direct-chat-msg right">
                                    ...
                                    <img class="direct-chat-img" src="/commerce/Util/Img/Users/${producto.avatar}" alt="Message User Image">
                                    <div class="direct-chat-text">
    ...
    $(document).on('click', '.imagen_pasarelas', (e) => {
        ...
        $('#imagen_principal').attr('src', '/commerce/Util/Img/producto/' + img);
    })
    ...
    async function realizar_respuesta(respuesta, id_pregunta) {
        ...
        let data = await fetch('/commerce/Controllers/RespuestaController.php',{
            method: 'POST',
            headers: {'Content-Type':'application/x-www-form-urlencoded'},
