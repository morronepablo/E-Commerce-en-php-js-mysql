                    ...
                    columns: [
                        ...
                        },
                        {
                            "render": function(data, type, datos, meta) {
                                let variable;
                                if(datos.abierto == '0') {
                                    variable = `<a style="color: #000" href="/commerce/Views/mensajes/read.php?option=${datos.f}&&id=${datos.id}"><strong>${datos.E_D}</strong></a>`;
                                } else {
                                    variable = `<a style="color: #000" href="/commerce/Views/mensajes/read.php?option=${datos.f}&&id=${datos.id}">${datos.E_D}</a>`;
                                }
                                return variable;
                            }
                        },
                        { 
                            "render":function(data, type, datos, meta) {
                                let variable;
                                if(datos.abierto == '0') {
                                    variable = `<a style="color: #000" href="/commerce/Views/mensajes/read.php?option=${datos.f}&&id=${datos.id}"><strong>${datos.asunto}</strong></a>`;
                                } else {
                                    variable = `<a style="color: #000" href="/commerce/Views/mensajes/read.php?option=${datos.f}&&id=${datos.id}">${datos.asunto}</a>`;
                                }
                                return variable;
                            }
                        },
