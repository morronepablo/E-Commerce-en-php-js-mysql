$(document).ready(function() {
            ...
            try {
                ...
                if(respuesta.mensaje == 'success') {
                    Swal.fire({
                        position: 'center',
                        icon: 'success',
                        title: 'Se eliminó el mensaje',
                        showConfirmButton: false,
                        timer: 1500
                    }).then(function() {
                        switch (respuesta.option) {
                            case '1':
                                location.href = '/commerce/Views/mensajes/';
                                break;
                            case '2':
                                location.href = '/commerce/Views/mensajes/sent.php';
                                break;
                            case '3':
                                location.href = '/commerce/Views/mensajes/favorites.php';
                                break;
    ...
    $(document).on('click', '.eliminar_mensaje', (e) => {
